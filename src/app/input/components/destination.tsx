...
function PlaceholdersAndVanishDestinationDemo({ nextStep, setDestination }: StepProps) {
      ...
      >
        <div className="h-[40rem] flex flex-col justify-center items-center px-4">
          ...
          <PlaceholdersAndVanishInput
            ...
            onSubmit={onSubmit} // Pass the vanishing state as a prop
          />
          <div className="mt-4">
...
export default PlaceholdersAndVanishDestinationDemo;
